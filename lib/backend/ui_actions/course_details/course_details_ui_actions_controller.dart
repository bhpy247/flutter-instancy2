...
class CourseDetailsUIActionsController {
  ...
  CatalogUIActionParameterModel getCatalogUIActionParameterModelFromContentDetailsDTOModel({required ContentDetailsDTOModel model}) {
    return CatalogUIActionParameterModel(
      ...
      isContentEnrolled: model.isContentEnrolled,
      bit4: model.bit4,
      eventRecording: model.recordingDetails != null,
      ViewLink: model.ViewLink,
