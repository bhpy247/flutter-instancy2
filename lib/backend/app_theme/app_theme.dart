...
class AppTheme {
  ...
  TextStyle getTextStyleWithFontFamily({TextStyle? textStyle}) {
    // return (textStyle ?? const TextStyle()).copyWith(fontFamily: "Roboto");
  ...
  ThemeData getLightTheme() {
    ...
    return ThemeData(
      ...
      buttonTheme: ButtonThemeData(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(styles.buttonBorderRadius))
      ),
      ...
      ).copyWith(background: Colors.white).copyWith(error: const Color(0xfff0323c)),
    );
  }
  ...
  ThemeData getDarkTheme() {
    ...
    return ThemeData(
      ...
      ).copyWith(background: Colors.black).copyWith(error: Colors.orange));
  }
  //endregion
