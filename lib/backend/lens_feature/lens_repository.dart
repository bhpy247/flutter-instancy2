...
class LensRepository {
  ...
  const LensRepository({required this.apiController});

  Future<DataResponseModel<String>> checkIsFallUnderBadCancelEnrollment({required String eventId}) async {
    MyPrint.printOnConsole('LensRepository().checkIsFallUnderBadCancelEnrollment() called with contentID:$eventId');
