class InstancyThemeColors {
  String _appBGColor = "";
  String get appBGColor => _appBGColor;
  set appBGColor(String value) {
    _appBGColor = value;
  }
  ...
  set expiredBGColor(String value) {
  ...
  set appLogoBackgroundColor(String value) {
  ...
  set appButtonTextColor(String value) {
  ...
  set fileUploadButtonColor(String value) {
  ...
  set menuBGAlternativeColor(String value) {
  ...
  set menuHeaderTextColor(String value) {
  ...
  set appHeaderTextColor(String value) {
  ...
  set menuHeaderBGColor(String value) {
  ...
  set appHeaderColor(String value) {
  ...
  set menuBGSelectTextColor(String value) {
  ...
  set selectedMenuTextColor(String value) {
  ...
  set selectedMenuBGColor(String value) {
  ...
  set menuTextColor(String value) {
  ...
  set appButtonBgColor(String value) {
  ...
  set appLoginTextolor(String value) {
  ...
  set appLoginBGColor(String value) {
