...
""";
  ...
  Widget getPageElementsListView({required List<MicroLearningPageElementModel> elements}) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return getPageElementWidgetByType(model: model);
      },
    );
  }

  Widget getPageElementWidgetByType({required MicroLearningPageElementModel model}) {
    if (model.elementType == MicroLearningElementType.Quiz) {
      return getQuizEditingWidget(model: model);
    } else if (model.elementType == MicroLearningElementType.Text) {
      return getTextEditingWidget(model: model);
    }
  ...
  Widget getQuizEditingWidget({required MicroLearningPageElementModel model, int index = 0}) {
    QuizQuestionModel? quizQuestionModel = model.quizQuestionModel;
  ...
  Widget getTextEditingWidget({required MicroLearningPageElementModel model}) {
    String htmlCode = model.htmlContentCode;
