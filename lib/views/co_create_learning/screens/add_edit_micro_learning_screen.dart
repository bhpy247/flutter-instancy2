...
""";
  ...
  Future<void> save() async {
    ...
    MicroLearningContentModel microLearningContentModel = MicroLearningContentModel(microLearningPages: microLearningList);
    coCreateContentAuthoringModel.microLearningContentModel = microLearningContentModel;
    MyPrint.printOnConsole("mainMicroLearningModel:  ${coCreateContentAuthoringModel.microLearningContentModel?.microLearningPages}");
  ...
  Future<CourseDTOModel?> saveContent() async {
    ...
    MicroLearningContentModel microLearningContentModel = coCreateContentAuthoringModel.microLearningContentModel ??= MicroLearningContentModel();
    microLearningContentModel.microLearningPages = microLearningList;
    coCreateContentAuthoringModel.microLearningContentModel = microLearningContentModel;
...
class MicroLearningViewScreen extends StatefulWidget {
  ...
  final MicroLearningViewScreenNavigationArgument arguments;

  const MicroLearningViewScreen({super.key, required this.arguments});

  @override
  State<MicroLearningViewScreen> createState() => _MicroLearningViewScreenState();
}

class _MicroLearningViewScreenState extends State<MicroLearningViewScreen> with MySafeState {
  double? maxHeight;
