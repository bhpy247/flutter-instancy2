...
class HtmlEditor2 extends StatefulWidget {
  const HtmlEditor2({super.key});

  @override
  State<HtmlEditor2> createState() => _HtmlEditor2State();
}

class _HtmlEditor2State extends State<HtmlEditor2> {
  String result = '';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Html Editor 2"),
          elevation: 0,
          actions: [
            IconButton(
