...
class TansferToAgentMessageItemWidget extends StatefulWidget {
  final ChatMessageModel message;
  final int currentUserId;
  final bool isMessageReceived;

  const TansferToAgentMessageItemWidget({Key? key, required this.message, required this.currentUserId, required this.isMessageReceived}) : super(key: key);

  @override
  State<TansferToAgentMessageItemWidget> createState() => _TansferToAgentMessageItemWidgetState();
}

class _TansferToAgentMessageItemWidgetState extends State<TansferToAgentMessageItemWidget> {
  ...
  void initState() {
    super.initState();
    MyPrint.printOnConsole("TansferToAgentMessageItemWidget init called");
    message = widget.message;
  }

  @override
  void didUpdateWidget(covariant TansferToAgentMessageItemWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    bool isMessageReceived = widget.isMessageReceived;
