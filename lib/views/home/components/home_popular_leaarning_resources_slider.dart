...
class _HomePopularLearningResourcesSliderState extends State<HomePopularLearningResourcesSlider> {
                      ...
                      builder: (BuildContext context, AsyncSnapshot snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          ...
                          return getCoursesSlider(
                            list: homeProvider.popularCourses,
                          );
                        } else {
  ...
  Widget getCoursesSlider({required List<NewCourseListDTOModel> list}) {
    return HomeCourseListCarousel(
        list: list, componentId: componentId, componentInstanceId: componentInstanceId, userId: homeController.homeRepository.apiController.apiDataProvider.getCurrentUserId());
  }
}
