...
class ConfirmRemoveExperienceByUserDialog extends StatelessWidget {
  final LocalStr? localStr;

  const ConfirmRemoveExperienceByUserDialog({
    Key? key,
    this.localStr,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CommonConfirmationDialog(
      ...
      description: localStrNew.profileAlertsubtitleDeleteexperience,
